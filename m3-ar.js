...
async function bot(m3, message) {
  ...
  if ((txt == "sticker") || (isMedia && mimetype == 'image/jpeg')) {
    const a = "mns bot"                //ضع هنا حقوق البوت التي تظهر اسفل الملصق للصور … يجب الاتحتوي على زخارف او ايموجي فقط بالانجيليزي
    const b = "mns bot"            //ضع هنا حقوق البوت التي تظهر اسفل الملصق للصور … يجب الاتحتوي على زخارف او ايموجي فقط بالانجيليزي
...
m3.sendText(from, 'استمتع بالملصق الخاص بك 🎁')
    ...
    sm += "ℹ️ تابع حسابي على تيليجرام @PROTECTmnbot إذا تم حظر هذا الروبوت ، فسيتم نشر رقم جديد هناك \n"
